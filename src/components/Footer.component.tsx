...
const Footer: React.FC = () => {
  ...
  // Contact information array for easy API integration
  ...
  // Social media links array for easy API integration
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                We deliver cutting-edge software development, cloud services, and digital transformation.
              </p>
            </div>

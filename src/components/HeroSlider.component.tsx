  ...
  const slides: SlideData[] = [
    {
      ...
      description: "We deliver cutting-edge software solutions that drive business growth and digital transformation.",
    ...
    },
    {
      ...
      description: "Build robust enterprise applications with our proven methodologies and industry best practices.",
    ...
    },
    {
      ...
      description: "Leverage our expertise to make informed technology decisions and accelerate your digital journey.",
                    ...
                    <div className="space-y-3">
                      {slide.bulletPoints.map((point, pointIndex) => (
                        <div key={pointIndex} className="flex items-center space-x-3">
                          ...
                          <span className="text-gray-200 dark:text-gray-300 font-medium">{point}</span>
                        </div>
                      ))}
                    </div>
                      ...
                      <div className="w-full h-96 bg-gradient-to-br from-blue-500/20 to-purple-600/20 dark:from-blue-600/30 dark:to-purple-700/30 rounded-2xl backdrop-blur-sm border border-white/10 dark:border-white/20">
                        <div className="absolute inset-4 bg-white/5 dark:bg-white/10 rounded-xl flex items-center justify-center">
                          <div className="text-center text-white dark:text-gray-100">
                            ...
                            <p className="text-gray-300 dark:text-gray-400">Enterprise-grade solutions</p>
                          </div>
                        </div>
                      </div>
                    </div>
